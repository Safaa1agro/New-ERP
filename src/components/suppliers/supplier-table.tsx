...
import { Eye, Edit, Trash2, CheckCircle, Clock, AlertTriangle, Building2, Star, ShieldCheck, ShieldAlert, Package } from 'lucide-react';
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <Link
                        ...
                        className="px-2 py-1 bg-slate-800 hover:bg-slate-700 text-emerald-400 border border-slate-700 rounded text-[11px] font-medium inline-flex items-center gap-1"
                        title="360° / KYC Details View"
                      >
